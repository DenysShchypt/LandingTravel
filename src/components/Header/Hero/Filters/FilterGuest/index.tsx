...
const FilterGuest:FC<IFilterGuestProps> = ({handleSelect}):JSX.Element => {
  const {
    isOpen,
  ...
  return (
    <div className="relative">
      <button
        type="button"
        {...getToggleButtonProps()}
        className="appearance-none font-medium  text-xl w-[186px] py-2 pl-8 text-black bg-lightgray focus:outline-none focus:border-none flex items-center justify-start"
      >
        {selectedItem ? selectedItem.label : "Guest"}
        <svg
