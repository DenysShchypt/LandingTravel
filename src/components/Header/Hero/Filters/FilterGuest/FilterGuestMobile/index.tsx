...
const FilterGuestMobile: FC = (): JSX.Element => {
  ...
  return (
    <div className=" w-full bg-white border-slate-200 p-5 rounded-[20px] shadow-lg ">
      <div className="flex items-center justify-between mb-4">
        <div className="">
          <h4 className="font-normal text-black text-sm">Adults </h4>
          <p className="font-normal text-[#999] text-xs">after 12 years old</p>
        </div>
      ...
      <div className="flex items-center justify-between">
        <div className="">
          ...
          <p className="font-normal text-[#999] text-xs">up to 12 years old</p>
        </div>
        <div className="flex items-center justify-between">
          <button
